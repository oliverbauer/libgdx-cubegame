...
public class YAMLLevel2 implements Level {
	...
	public YAMLLevel2(GameScreen cubeApp, PerspectiveCamera cam) {
		...
		field()[5][0][15] = BlockFactory.createGround(5, 0, 15);
		field()[5][0][16] = BlockFactory.createGround(5, 0, 16);
		field()[5][0][17] = BlockFactory.createGround(5, 0, 17);
		field()[5][0][18] = BlockFactory.createGround(5, 0, 18);
		field()[5][0][19] = BlockFactory.createGround(5, 0, 19);
		field()[5][0][20] = BlockFactory.createGround(5, 0, 20);
		field()[5][0][21] = BlockFactory.createGround(5, 0, 21);
		...
		field()[4][0][14] = BlockFactory.createGround(4, 0, 14);
		field()[4][0][15] = BlockFactory.createGround(4, 0, 15);
		field()[4][0][16] = BlockFactory.createGround(4, 0, 16);
		field()[4][0][17] = BlockFactory.createGround(4, 0, 17);
		field()[4][0][18] = BlockFactory.createGround(4, 0, 18);
		field()[4][0][19] = BlockFactory.createGround(4, 0, 19);
		field()[4][0][20] = BlockFactory.createGround(4, 0, 20);
		field()[4][0][21] = BlockFactory.createGround(4, 0, 21);
		field()[4][0][22] = BlockFactory.createGround(4, 0, 22);
		...
		field()[3][0][11] = BlockFactory.createJumper(Color.BLUE, BlockType.RIGHT_SHIFT, 3,0,11);
		field()[3][0][13] = BlockFactory.createGround(3, 0, 13);
		field()[3][0][14] = BlockFactory.createGround(3, 0, 14);
		field()[3][0][15] = BlockFactory.createGround(3, 0, 15);
		field()[3][0][16] = BlockFactory.createGround(3, 0, 16);
		field()[3][0][17] = BlockFactory.createGround(3, 0, 17);
		field()[3][0][18] = BlockFactory.createGround(3, 0, 18);
		field()[3][0][19] = BlockFactory.createGround(3, 0, 19);
		field()[3][0][20] = BlockFactory.createGround(3, 0, 20);
		field()[3][0][21] = BlockFactory.createGround(3, 0, 21);
		field()[3][0][22] = BlockFactory.createGround(3, 0, 22);
		field()[3][0][23] = BlockFactory.createGround(3, 0, 23);
		...
		field()[2][0][11] = BlockFactory.createGround(2, 0, 11);
		field()[2][0][13] = BlockFactory.createJumper(Color.BLUE, BlockType.LEFT_SHIFT, 2, 0, 13);
		field()[2][0][14] = BlockFactory.createGround(2, 0, 14);
		field()[2][0][15] = BlockFactory.createGround(2, 0, 15);
		field()[2][0][16] = BlockFactory.createGround(2, 0, 16);
		field()[2][0][17] = BlockFactory.createGround(2, 0, 17);
		field()[2][0][18] = BlockFactory.createGround(2, 0, 18);
		field()[2][0][19] = BlockFactory.createGround(2, 0, 19);
		field()[2][0][20] = BlockFactory.createGround(2, 0, 20);
		field()[2][0][21] = BlockFactory.createGround(2, 0, 21);
		field()[2][0][22] = BlockFactory.createGround(2, 0, 22);
		field()[2][0][23] = BlockFactory.createGround(2, 0, 23);
		...
		field()[1][0][14] = BlockFactory.createGround(1, 0, 14);
		field()[1][0][15] = BlockFactory.createGround(1, 0, 15);
		field()[1][0][16] = BlockFactory.createGround(1, 0, 16);
		field()[1][0][17] = BlockFactory.createGround(1, 0, 17);
		field()[1][0][18] = BlockFactory.createGround(1, 0, 18);
		field()[1][0][19] = BlockFactory.createGround(1, 0, 19);
		field()[1][0][20] = BlockFactory.createGround(1, 0, 20);
		field()[1][0][21] = BlockFactory.createGround(1, 0, 21);
		field()[1][0][22] = BlockFactory.createGround(1, 0, 22);
		...
		field()[0][0][15] = BlockFactory.createGround(0, 0, 15);
		field()[0][0][16] = BlockFactory.createGround(0, 0, 16);
		field()[0][0][17] = BlockFactory.createGround(0, 0, 17);
		field()[0][0][18] = BlockFactory.createGround(0, 0, 18);
		field()[0][0][19] = BlockFactory.createGround(0, 0, 19);
		field()[0][0][20] = BlockFactory.createGround(0, 0, 20);
		field()[0][0][21] = BlockFactory.createGround(0, 0, 21);
