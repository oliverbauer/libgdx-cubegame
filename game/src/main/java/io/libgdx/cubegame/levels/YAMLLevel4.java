...
public class YAMLLevel4 extends Level {
	...
	public YAMLLevel4(GameScreen cubeApp, PerspectiveCamera cam) {
		...
		field()[9][2][0] = arrow1;
		field()[9][0][0] = TileFactory.createElevator(BlockType.ELEVATOR_UP, 9, 0, 0);
		...
		field()[9][2][8] = arrow2;
		field()[9][0][8] = TileFactory.createElevator(BlockType.ELEVATOR_UP, 9, 0, 8);
		...
		field()[0][2][0] = arrow3;
		field()[0][0][0] = TileFactory.createElevator(BlockType.ELEVATOR_UP, 0, 0, 0);
		...
		field()[0][2][8] = arrow4;
		field()[0][0][8] = TileFactory.createElevator(BlockType.ELEVATOR_UP, 0, 0, 8);
		...
		field()[9][8][3] = arrow5;
		field()[9][6][3] = TileFactory.createElevator(BlockType.ELEVATOR_DOWN, 9, 6, 3);
		...
		field()[9][8][5] = arrow6;
		field()[9][6][5] = TileFactory.createElevator(BlockType.ELEVATOR_DOWN, 9, 6, 5);
		...
		field()[0][8][3] = arrow7;
		field()[0][6][3] = TileFactory.createElevator(BlockType.ELEVATOR_DOWN, 0, 6, 3);
		...
		field()[0][8][5] = arrow8;
		field()[0][6][5] = TileFactory.createElevator(BlockType.ELEVATOR_DOWN, 0, 6, 5);
