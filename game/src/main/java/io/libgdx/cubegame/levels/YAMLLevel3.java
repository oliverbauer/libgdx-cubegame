...
public class YAMLLevel3 implements Level {
	...
	public YAMLLevel3(GameScreen cubeApp, PerspectiveCamera cam) {
		...
		field()[5][2][0] = arrow1;
		field()[5][0][0] = BlockFactory.createElevator(BlockType.ELEVATOR_UP, 5, 0, 0);
		...
		field()[5][0][9] = BlockFactory.createGround(5, 0, 9);
		field()[5][0][10] = BlockFactory.createGround(5, 0, 10);
		field()[4][0][0] = BlockFactory.createGround(4, 0, 0);
		...
		field()[4][0][10] = BlockFactory.createGround(4, 0, 10);
		...
		field()[1][0][10] = BlockFactory.createGround(1, 0, 10);
		field()[0][0][0] = BlockFactory.createGround(0, 0, 0);
		...
		field()[0][0][9] = BlockFactory.createGround(0, 0, 9);
		field()[0][0][10] = BlockFactory.createGround(0, 0, 10);
		field()[5][3][0] = BlockFactory.createGround(5, 3, 0);
		field()[5][3][1] = BlockFactory.createGround(5, 3, 1);
		field()[5][3][2] = BlockFactory.createGround(5, 3, 2);
		field()[5][3][3] = BlockFactory.createGround(5, 3, 3);
		field()[5][3][4] = BlockFactory.createGround(5, 3, 4);
		field()[5][3][5] = BlockFactory.createGround(5, 3, 5);
		field()[5][3][6] = BlockFactory.createGround(5, 3, 6);
		field()[5][3][7] = BlockFactory.createGround(5, 3, 7);
		field()[5][3][8] = BlockFactory.createGround(5, 3, 8);
		field()[5][3][9] = BlockFactory.createGround(5, 3, 9);
		field()[5][3][10] = BlockFactory.createGround(5, 3, 10);
		...
		field()[0][3][2] = BlockFactory.createGround(0, 3, 2);
		field()[0][3][3] = BlockFactory.createGround(0, 3, 3);
		field()[0][3][4] = BlockFactory.createGround(0, 3, 4);
		field()[0][3][5] = BlockFactory.createGround(0, 3, 5);
		field()[0][3][6] = BlockFactory.createGround(0, 3, 6);
		field()[0][3][7] = BlockFactory.createGround(0, 3, 7);
		field()[0][3][8] = BlockFactory.createGround(0, 3, 8);
		field()[0][3][9] = BlockFactory.createGround(0, 3, 9);
		field()[0][3][10] = BlockFactory.createGround(0, 3, 10);
	...
	public void enemyPath2(Color color) {
		field()[0][5][8] = BlockFactory.createEnemy(color, 0,5,8);
		EnemyAnimation r = new EnemyAnimation(cubeApp);
